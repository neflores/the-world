      ...
      locations.add(
        WorldLocation(
          ...
          appearance: WorldAppearance(
            ...
            banner: i == 1,
            festival: i == 0,
            tier: i == 3 ? WorldTier.stall : WorldTier.workshop,
            theme: WorldTheme.values[i % 3],
          ...
          representativeId: i >= 3 ? 'representative-${city.id}-$i' : null,
          isDemo: true,
          isFavorite: i == 0,
        ),
      );
